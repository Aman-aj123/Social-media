...
//      const optionItems = document.querySelectorAll(".select-option-menus .option-items");


//      optionItems.forEach(element => {
//           element.addEventListener("click", () => {
//                const optionItemsLinks = element.querySelector("p").innerHTML.toLowerCase();
//                window.open(`/${optionItemsLinks}.html`);
//           });
//      });
// }
